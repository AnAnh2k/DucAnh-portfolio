    ...
    <>
      ...
      <div className="portfolio-theme min-h-dvh flex flex-col bg-slate-950 text-slate-100 font-sans scroll-smooth selection:bg-blue-500/30 relative z-10">
        ...
        <main className="flex-1 relative z-10 w-full max-w-6xl mx-auto px-6 pt-10 md:pt-12">
          ...
          <section
            id="AboutSection"
            className="min-h-[calc(100dvh-120px)] flex flex-col md:flex-row items-center justify-between gap-12 md:gap-24 py-10 md:py-20 max-w-6xl mx-auto"
          >
            <div className="flex-1 space-y-8 text-center md:text-left">
              ...
              <div className="flex flex-wrap items-center gap-4 pt-6 justify-center md:justify-start">
                <a href="#ProjectContainer">
                  <Button
                    size="lg"
                    className="rounded-full px-8 bg-white text-slate-950 hover:bg-slate-200 font-bold h-12 text-sm shadow-[0_0_20px_rgba(255,255,255,0.1)]"
                  >
                ...
                <a href="/CV_AnDucAnh.pdf" target="_blank">
                  <Button
                    variant="outline"
                    size="lg"
                    className="rounded-full px-6 border-slate-700 bg-slate-900/50 hover:bg-slate-800 text-slate-200 h-12 text-sm flex items-center gap-2"
                  >
                    <Download className="w-4 h-4" /> Tải CV
                  </Button>
                </a>
                <a href="https://github.com/AnAnh2k" target="_blank">
                  <Button
                    variant="outline"
                    size="icon"
            ...
            <div className="flex-1 flex justify-center md:justify-end relative">
              <div className="relative w-64 h-64 md:w-[350px] md:h-[350px] group">
                <div className="absolute inset-0 rounded-full bg-emerald-400/20 blur-[100px] group-hover:bg-emerald-400/30 transition-colors" />
