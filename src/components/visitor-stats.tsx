  ...
  useEffect(() => {
    ...
    const fetchStats = async () => {
      try {
        ...
        // Lấy số truy cập hôm nay (Tính theo ngày hiện tại)
        const now = new Date()
            ...
            <div className="w-full space-y-4 animate-in fade-in zoom-in-95 duration-300">
              <div className="flex items-center justify-between border-b border-white/5 pb-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-black text-white uppercase tracking-widest italic">Live Traffic</span>
                </div>
              ...
              <div className="grid grid-cols-1 gap-3">
                <div className="flex items-center justify-between p-2.5 rounded-xl bg-white/5 border border-white/5">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-bold text-white/50 uppercase tracking-tight">Đang Online</span>
                  </div>
                ...
                <div className="flex items-center justify-between p-2.5 rounded-xl bg-white/5">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-bold text-white/50 uppercase tracking-tight">Tổng lượt xem</span>
                  </div>
